...
실행 후 브라우저에서 `http://127.0.0.1:8000`으로 접속하면 모바일 카드형
첫 화면을 볼 수 있습니다. 첫 화면에는 큰 제목과 미션, 통장, 성장, 우리아이
카드만 표시되며 각 카드를 누르면 상세 화면으로 이동합니다.
...
# 첫 화면 카드 요약
curl 'http://127.0.0.1:8000/api/dashboard?user_id=1&date=2026-06-09'
